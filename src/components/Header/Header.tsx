    ...
    return (
        <div className="text-white py-4 mt-6 z-[900] absolute left-[50%] translate-x-[-50%] w-[80%] flex  items-center justify-between">
            ...
            <div className="flex gap-4 w-full justify-end">
                <a href="https://www.linkedin.com/in/utkarsh-singh-5630b42aa/" target="_blank" className="hidden md:flex cursor-pointer gap-2 font-light justify-center items-center">
                    Linkedin
                    <IoIosArrowRoundForward className="rotate-[-45deg] text-2xl" />
                </a>
                <a href="https://drive.google.com/file/d/1q25HSTjPWP8skAQ9JE5f9RTdrcS7B3ND/view" target="_blank" className="flex gap-2 font-light justify-center items-center">
                    Resume
                    <IoIosArrowRoundForward className="rotate-[-45deg] text-2xl"/>
                </a>
            </div>
