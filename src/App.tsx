  ...
  return (
    <ThemeProvider>
      <main className="bg-white dark:bg-[#000814]">
          ...
          <div className="flex flex-col-reverse items-center lg:flex-row w-full lg:w-[70vw] gap-16 lg:gap-32 mx-auto mt-16 pt-16 dark:text-white text-black">
            <div className="w-full flex flex-col items-center justify-center gap-4 lg:gap-8">
              ...
              <p className="text-[16px] lg:text-[18px] text-black/60 dark:text-white/80 text-center lg:text-start">
                ...
                entrepreneurial mindset drives me to create digital experiences
                that resonate with users and drive success.
              </p>
            </div>
        ...
        {/* <Footer /> */}
        <div className="dark:text-white text-black text-[0.9rem] flex flex-col md:flex-row justify-center items-center md:justify-between w-[80%] mx-auto border-t-[1px] border-black/50 dark:border-[#ffffff49] md:px-10 py-6 mt-10">
          <div>©️ 2024, Utkarsh Singh</div>
          <div>Made with love💜 and coffee ☕ of course</div>
        </div>
      </main>
    </ThemeProvider>
  );
